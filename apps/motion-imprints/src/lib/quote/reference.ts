/**
 * Human-readable request references, e.g. MI-Q-260923-7KQ4M (Q quote, M message, A assistant handoff).
 *
...
export type ReferenceKind = "Q" | "M" | "A";
...
export const REFERENCE_PATTERN = /^MI-[QMA]-\d{6}-[0-9A-HJKMNP-TV-Z]{5}$/;
