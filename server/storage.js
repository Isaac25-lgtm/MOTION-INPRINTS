...
export function createStorageAdapter() { return { createUploadUrl: async () => { throw new ApiError(501, 'storage_not_configured', 'An approved object-storage provider has not been configured.') }, createDownloadUrl: async () => { throw new ApiError(501, 'storage_not_configured', 'An approved object-storage provider has not been configured.') } } }
